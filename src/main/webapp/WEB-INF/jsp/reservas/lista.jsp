...
<body>
 ...
 <c:if test="${not empty mensagem}">
            ...
            <div class="mb-5 flex items-center">
                <h1 class="text-3xl font-bold text-white antialiased">Reservas</h1>
                <div class="text-right ml-8">
                  <a class="rounded-lg bg-green-400 py-2 px-5 font-bold text-white" href="/reservas/new">New</a>
                </div>
              </div>
              ...
              <c:if test="${empty lista}">
                       <div>
                        <p class="truncate text-sm font-medium text-gray-900 dark:text-white">Nenhuma reserva cadastrada</p>
                      </div>
              </c:if>
              <c:if test="${not empty lista}"> 
                <div class="mb-5 flex items-center">
                  <ul class="max-w-md divide-y divide-gray-200 dark:divide-gray-700">
                      <div>
                        <p class="truncate text-sm font-medium text-gray-900 dark:text-white">Reservas: ${lista.size()}</p>
                      </div>
                      ...
                      <div class="flex items-center space-x-4">
                        ...
                        <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                          <a class="relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray                         -900 rounded-lg group bg-gradient-to-br from-pink-500 to-orange-400 group-hover:from-pink-500 group-hover:to-orange-400 hover:                          text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800" href="/reservas/${u.id}/excluir">
